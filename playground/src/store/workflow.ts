...
import type { Workflow, WorkflowNode, WorkflowEdge, WorkflowFolder, NodeTemplate, WorkflowNodeType } from '#/types/workflow';
...
export const useWorkflowStore = defineStore('workflow', () => {
  ...
  const nodeTemplates: NodeTemplate[] = [
    { type: 'start', label: '开始', icon: 'mdi:play-circle', category: '基础', description: '流程的起始节点' },
    { type: 'end', label: '结束', icon: 'mdi:stop-circle', category: '基础', description: '流程的结束节点' },
    { type: 'llm', label: 'LLM', icon: 'mdi:brain', category: 'AI', description: '调用大语言模型' },
    { type: 'prompt', label: '提示词', icon: 'mdi:file-text', category: 'AI', description: '定义提示词模板' },
    { type: 'code', label: '代码', icon: 'mdi:code', category: '工具', description: '执行自定义代码' },
    { type: 'condition', label: '条件', icon: 'mdi:git-branch', category: '控制', description: '条件分支判断' },
    { type: 'webhook', label: 'Webhook', icon: 'mdi:webhook', category: '工具', description: '发送HTTP请求' },
    { type: 'data', label: '数据', icon: 'mdi:database', category: '数据', description: '数据处理节点' },
    { type: 'input', label: '输入', icon: 'mdi:input', category: '数据', description: '流程输入参数' },
    { type: 'output', label: '输出', icon: 'mdi:output', category: '数据', description: '流程输出结果' },
  ];
